...
<body>
    <ul>
        <li>
            ...
            <a href="listarPergunta">Listar pergunta</a>
        </li>
    </ul>
</body>
...
if (!empty($linhas)) 
{
    ...
    foreach ($linhas as $linha) {
        ...
        if (count($dados) >= 3) 
        {
            ...
            $perguntas[] = ['pergunta' => $pergunta,'opcoes' => $opcoes, 'respostasCorretas' => $respostasCorretas];
        }
    }
    ...
    if (!empty($perguntas)) 
    {
        ...
        foreach ($perguntas as $indice => $perguntaData) 
        {
            ...
            foreach ($opcoes as $opcao) {
                echo '<label>';
                echo '<input type="radio" name="respostas' . $indice . '[]" value="' . $opcao . '"> ' . $opcao;
                echo '</label><br>';
            }
